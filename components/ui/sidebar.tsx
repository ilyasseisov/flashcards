...
function SidebarMenuSub({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      className={cn(
        "border-sidebar-border mx-3.5 flex min-w-0 translate-x-px flex-col gap-1.5", // Changed gap-1 to gap-1.5
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        "flex min-h-[1.75rem] min-w-0 -translate-x-px items-start gap-2 rounded-md px-2 py-1.5",
        ...
        size === "md" && "text-sm",
        "group-data-[collapsible=icon]:hidden",
        "break-words", // Add this to allow word breaking
        className,
      )}
      {...props}
    />
